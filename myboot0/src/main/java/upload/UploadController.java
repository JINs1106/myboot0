...
public class UploadController {
	...
	public String uploadResult(@ModelAttribute("vo") UploadVO vo) throws IOException, BindException{
		//전송 파일 2개 객체 생성
	...
	public ModelAndView showMyFileList(String name) throws IOException {
